...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 shadow-soft hover:shadow-medium hover:-translate-y-0.5",
        destructive:
        ...
        hero: "bg-gradient-to-r from-primary via-accent to-secondary text-primary-foreground shadow-glow hover:shadow-float hover:-translate-y-1 hover:scale-105 border-2 border-primary-foreground/20",
        glass:
          "bg-card/60 backdrop-blur-xl border border-border/40 text-foreground hover:bg-card/80 shadow-soft",
        accent:
